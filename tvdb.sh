...
print_series_info() {
    ...
    # $1: series id
    # $2: data file
    echo -e "$($_JQ -r '.data | .[] | select(.id==($id | tonumber)) | "\\033[1m\\033[33m" + .seriesName + "\\033[0m\\033[0m", "\\033[1mFirst Aired:\\033[0m+" + .firstAired, "\\033[1mStatus:\\033[0m+" + .status, "\\033[1mOverview:\\033[0m+" + .overview, "+"' --arg id "$1" < "$2" | column -t -s"+")"
}
